...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisMedallista() {
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país al que pertenece el medallista");
	...
	private void ejecutarPaisDeAtleta() {
	    ...
	    String atleta = input("Por favor, introduce el nombre del atleta: ");
	    Atleta atletaEncontrado = calculadora.buscarPaisAtleta(atleta);

	    if (atletaEncontrado != null) {
	        String nombreAtleta = atletaEncontrado.darNombre(); 
	        Pais paisAtleta = atletaEncontrado.darPais(); 

	        System.out.println("El atleta " + nombreAtleta + " pertenece a " + paisAtleta);
	    } else {
